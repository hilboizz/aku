...
def login_men():
	try:
		...
		banner()
		print('{hijo}─────────────────────────────')
		your_cookies = input(f'└── cookies :{xxx}{ung} ')
...
def menu(id):
	...
	banner()
	print(f'{xxx}{kun}─────────────────────────────')
	print(f'{xxx}{bira} A=PUBLIK B=FILE')
	print(f'{xxx}{hijo}└── A or B')
	helpbas = input(f'{xxx}└── : ')
	if helpbas in ['a','A','1']:
		nge_krek()
	elif helpbas in ['b','B','2']:
		file_dump()
	else:
...
def atur_dulu():
	...
	print(f'{kun}─────────────────────────────')
	print(f'{biru}└── tambahkan ua y atau t')
	uatambah = input(f'└── : ')
